  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        dental: {
          trust: "hsl(var(--dental-trust))",
          clean: "hsl(var(--dental-clean))",
          comfort: "hsl(var(--dental-comfort))",
        },
        primary: {
      ...
      keyframes: {
        ...
        "soft-glow": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--lavender-primary) / 0.3)" },
          "50%": { boxShadow: "0 0 30px hsl(var(--lavender-primary) / 0.5)" }
        }
      },
      animation: {
